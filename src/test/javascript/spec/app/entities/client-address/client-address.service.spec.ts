...
describe('Service Tests', () => {
    describe('ClientAddress Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ClientAddressService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/client-addresses';
                expect(req.request.url).toEqual(resourceUrl + '/' + '123');
            });

            it('should create a ClientAddress', () => {
                service.create(new ClientAddress(null)).subscribe(received => {
            ...
            it('should update a ClientAddress', () => {
                service.update(new ClientAddress('123')).subscribe(received => {
            ...
            it('should return a ClientAddress', () => {
            ...
            it('should return a list of ClientAddress', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new ClientAddress('123')]);
            });
